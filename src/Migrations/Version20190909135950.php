 ...
 */
final class Version20190909135950 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE catalog (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', title CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', description CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', language VARCHAR(255) DEFAULT NULL, license VARCHAR(255) DEFAULT NULL, fdp CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', slug VARCHAR(255) NOT NULL, version VARCHAR(255) NOT NULL, issued DATETIME NOT NULL, modified DATETIME NOT NULL, homepage VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_1B2C32472B36786B (title), UNIQUE INDEX UNIQ_1B2C32476DE44026 (description), INDEX IDX_1B2C3247D4DB71B5 (language), INDEX IDX_1B2C32475768F419 (license), INDEX IDX_1B2C3247E28FB11F (fdp), INDEX slug (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE dataset (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', title CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', description CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', language VARCHAR(255) DEFAULT NULL, license VARCHAR(255) DEFAULT NULL, keyword CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', study_id VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) NOT NULL, version VARCHAR(255) NOT NULL, issued DATETIME NOT NULL, modified DATETIME NOT NULL, landing_page VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_B7A041D02B36786B (title), UNIQUE INDEX UNIQ_B7A041D06DE44026 (description), INDEX IDX_B7A041D0D4DB71B5 (language), INDEX IDX_B7A041D05768F419 (license), UNIQUE INDEX UNIQ_B7A041D05A93713B (keyword), UNIQUE INDEX UNIQ_B7A041D0E7B003E9 (study_id), INDEX slug (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE distribution (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', title CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', description CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', language VARCHAR(255) DEFAULT NULL, license VARCHAR(255) DEFAULT NULL, dataset_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', slug VARCHAR(255) NOT NULL, version VARCHAR(255) NOT NULL, issued DATETIME NOT NULL, modified DATETIME NOT NULL, dtype VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_A44837812B36786B (title), UNIQUE INDEX UNIQ_A44837816DE44026 (description), INDEX IDX_A4483781D4DB71B5 (language), INDEX IDX_A44837815768F419 (license), INDEX IDX_A4483781D47C2D1B (dataset_id), INDEX slug (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE license (slug VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(slug)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id VARCHAR(255) NOT NULL, full_name VARCHAR(255) NOT NULL, name_first VARCHAR(255) NOT NULL, name_middle VARCHAR(255) DEFAULT NULL, name_last VARCHAR(255) NOT NULL, email_address VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
