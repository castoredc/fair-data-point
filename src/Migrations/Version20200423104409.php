...
final class Version20200423104409 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE distribution_databases CHANGE user user TEXT NOT NULL, CHANGE `password` `password` TEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE distribution_databases CHANGE user user VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, CHANGE `password` `password` VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`');
