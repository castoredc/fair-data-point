 ...
 */
final class Version20190911140714 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE agent (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', fdp CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', slug VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, dtype VARCHAR(255) NOT NULL, INDEX IDX_268B9C9DE28FB11F (fdp), INDEX slug (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE catalog (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', title CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', description CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', language VARCHAR(190) DEFAULT NULL, license VARCHAR(190) DEFAULT NULL, fdp CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', slug VARCHAR(255) NOT NULL, version VARCHAR(255) NOT NULL, issued DATETIME NOT NULL, modified DATETIME NOT NULL, homepage VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_1B2C32472B36786B (title), UNIQUE INDEX UNIQ_1B2C32476DE44026 (description), INDEX IDX_1B2C3247D4DB71B5 (language), INDEX IDX_1B2C32475768F419 (license), INDEX IDX_1B2C3247E28FB11F (fdp), INDEX slug (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE catalogs_publishers (catalog_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', agent_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_EBE984D4CC3C66FC (catalog_id), INDEX IDX_EBE984D43414710B (agent_id), PRIMARY KEY(catalog_id, agent_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE dataset (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', title CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', description CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', language VARCHAR(190) DEFAULT NULL, license VARCHAR(190) DEFAULT NULL, keyword CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', study_id VARCHAR(190) DEFAULT NULL, slug VARCHAR(255) NOT NULL, version VARCHAR(255) NOT NULL, issued DATETIME NOT NULL, modified DATETIME NOT NULL, landing_page VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_B7A041D02B36786B (title), UNIQUE INDEX UNIQ_B7A041D06DE44026 (description), INDEX IDX_B7A041D0D4DB71B5 (language), INDEX IDX_B7A041D05768F419 (license), UNIQUE INDEX UNIQ_B7A041D05A93713B (keyword), UNIQUE INDEX UNIQ_B7A041D0E7B003E9 (study_id), INDEX slug (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE datasets_publishers (dataset_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', agent_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_6AC743C2D47C2D1B (dataset_id), INDEX IDX_6AC743C23414710B (agent_id), PRIMARY KEY(dataset_id, agent_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE datasets_contactpoints (dataset_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', agent_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_317B24E6D47C2D1B (dataset_id), INDEX IDX_317B24E63414710B (agent_id), PRIMARY KEY(dataset_id, agent_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE distribution (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', title CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', description CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', language VARCHAR(190) DEFAULT NULL, license VARCHAR(190) DEFAULT NULL, dataset_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', slug VARCHAR(255) NOT NULL, version VARCHAR(255) NOT NULL, issued DATETIME NOT NULL, modified DATETIME NOT NULL, dtype VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_A44837812B36786B (title), UNIQUE INDEX UNIQ_A44837816DE44026 (description), INDEX IDX_A4483781D4DB71B5 (language), INDEX IDX_A44837815768F419 (license), INDEX IDX_A4483781D47C2D1B (dataset_id), INDEX slug (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE distributions_publishers (distribution_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', agent_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_6AF6FE206EB6DDB5 (distribution_id), INDEX IDX_6AF6FE203414710B (agent_id), PRIMARY KEY(distribution_id, agent_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE fdp (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', title CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', description CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', language VARCHAR(190) DEFAULT NULL, license VARCHAR(190) DEFAULT NULL, iri VARCHAR(255) NOT NULL COMMENT \'(DC2Type:iri)\', version VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_E28FB11F2B36786B (title), UNIQUE INDEX UNIQ_E28FB11F6DE44026 (description), INDEX IDX_E28FB11FD4DB71B5 (language), INDEX IDX_E28FB11F5768F419 (license), INDEX iri (iri), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE fdp_publishers (fairdata_point_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', agent_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_C3450E8BB0D86935 (fairdata_point_id), INDEX IDX_C3450E8B3414710B (agent_id), PRIMARY KEY(fairdata_point_id, agent_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE localized_text_item (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', parent CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', language VARCHAR(190) DEFAULT NULL, text VARCHAR(255) NOT NULL, INDEX IDX_B4CBD5BE3D8E604F (parent), INDEX IDX_B4CBD5BED4DB71B5 (language), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE organization (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', homepage VARCHAR(255) DEFAULT NULL COMMENT \'(DC2Type:iri)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE person (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', orcid VARCHAR(255) NOT NULL COMMENT \'(DC2Type:iri)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE catalogs_publishers ADD CONSTRAINT FK_EBE984D43414710B FOREIGN KEY (agent_id) REFERENCES agent (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE datasets_publishers ADD CONSTRAINT FK_6AC743C23414710B FOREIGN KEY (agent_id) REFERENCES agent (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE datasets_contactpoints ADD CONSTRAINT FK_317B24E63414710B FOREIGN KEY (agent_id) REFERENCES agent (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE distributions_publishers ADD CONSTRAINT FK_6AF6FE203414710B FOREIGN KEY (agent_id) REFERENCES agent (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE fdp_publishers ADD CONSTRAINT FK_C3450E8B3414710B FOREIGN KEY (agent_id) REFERENCES agent (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE catalogs_publishers DROP FOREIGN KEY FK_EBE984D43414710B');
        $this->addSql('ALTER TABLE datasets_publishers DROP FOREIGN KEY FK_6AC743C23414710B');
        $this->addSql('ALTER TABLE datasets_contactpoints DROP FOREIGN KEY FK_317B24E63414710B');
        $this->addSql('ALTER TABLE distributions_publishers DROP FOREIGN KEY FK_6AF6FE203414710B');
        $this->addSql('ALTER TABLE fdp_publishers DROP FOREIGN KEY FK_C3450E8B3414710B');
        ...
        $this->addSql('ALTER TABLE fdp_publishers DROP FOREIGN KEY FK_C3450E8BB0D86935');
