 ...
 */
final class Version20240126142819 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE metadata_model_node_value (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', is_annotated_value TINYINT(1) NOT NULL, data_type VARCHAR(255) NOT NULL COMMENT \'(DC2Type:XsdDataType)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE metadata_model_prefix (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', created_by CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', updated_by CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', metadata_model CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', prefix VARCHAR(255) NOT NULL, uri VARCHAR(255) NOT NULL COMMENT \'(DC2Type:iri)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL, INDEX IDX_F802EAEBDE12AB56 (created_by), INDEX IDX_F802EAEB16FE72E1 (updated_by), INDEX IDX_F802EAEB35F6CABB (metadata_model), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE metadata_model_prefix ADD CONSTRAINT FK_F802EAEB35F6CABB FOREIGN KEY (metadata_model) REFERENCES metadata_model_version (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE metadata_model_prefix DROP FOREIGN KEY FK_F802EAEB35F6CABB');
