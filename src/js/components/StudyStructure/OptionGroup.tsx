...
> {
  ...
  removeAnnotation = () => {
    ...
    apiClient
      .delete(
        `/api/study/${studyId}/annotations/${modalData.remove.annotation.id}`
      )
      .then(() => {
        toast.success(
          <ToastContent
            type="success"
            message="The annotation was successfully removed"
          />,
          {
            position: "top-right",
          }
      ...
      <div className="OptionGroupTable LargeTable">
        ...
        {modalData.remove && (
          ...
          >
            ...
            <strong>{modalData.remove.annotation.concept.displayName}</strong>{" "}
        ...
        <div className="OptionGroupTableBody TableBody">
          {options.length === 0 ? (
            <div className="NoResults">
              This option group does not contain options.
            </div>
          ) : (
            <div>
              {options.map((option) => {
