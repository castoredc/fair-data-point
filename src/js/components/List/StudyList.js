  ...
  render() {
    ...
    return (
      <StickyContainer className="StickyContainer">
        <div
          className={classNames("Studies HasFilters", className)}
          ref={this.wrapperRef}
        >
          {representation === "list" && (
            <div
              className={classNames("LargeList", isLoadingStudies && "Loading")}
            >
              {studies.length > 0 ? (
                <div>
            ...
            {({ style, isSticky }) => {
              return (
                <div
                  className={classNames(
                    "StickySideCol",
                    !allowFilterOverlay && isSticky && "Sticky"
                  )}
