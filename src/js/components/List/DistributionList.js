...
export default class DistributionList extends Component {
  ...
  render() {
    ...
    if (distributions === null) {
      return (
        <LoadingOverlay accessibleLabel="Loading distributions" content="" />
      );
    }
      ...
      <div className={classNames("Distributions", className)}>
        {distributions.length > 0 ? (
            ...
            {distributions.map((distribution) => {
              ...
              return (
                <ListItem
                  ...
                  newWindow={embedded}
                  smallIcon={
                    (distribution.accessRights === 2 ||
                      distribution.accessRights === 3) &&
                    "lock"
                  }
                />
              );
          ...
          <div className="NoResults">
            This dataset does not have any associated distributions.
          </div>
        )}
      </div>
    );
