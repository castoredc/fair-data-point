...
export default class StudyFilters extends Component {
    ...
    render() {
        ...
        return (
            <div className={classNames('FilterForm', overlay && 'Overlay', sticky && 'Sticky', className)} style={style}>
                <ValidatorForm ref={node => (this.form = node)} onSubmit={() => {}}>
                    <div className="FilterBlock">
                        <Input name="search" onChange={this.handleChange} value={data.search} placeholder="Search ..." />
                    </div>
                    {showFilters > 0 && (
                        <div className="FilterBlock">
                            ...
                            {showStudyType && (
                                <FormItem label="Type">
                                    <CheckboxGroup options={options.studyType} value={data.studyType} name="studyType" onChange={this.handleChange} />
                                </FormItem>
                            )}
