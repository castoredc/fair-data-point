...
export default class ModuleMappingInterface extends Component {
    constructor(props) {
        ...
        this.state = {
            data: {
                type: (props.mapping && props.mapping.element) ? props.mapping.element.structureType : 'report',
    ...
    handleSubmit = () => {
        ...
        axios.post('/api/dataset/' + dataset + '/distribution/' + distribution.slug + '/contents/rdf/v/' + versionId + '/module', {
            type: 'module',
