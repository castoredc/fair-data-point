...
> {
  ...
  render() {
    const { studyId } = this.props;
    const { contacts, isLoading, openModal, openRemoveModal, selectedContact } =
      this.state;
      ...
      return {
        ...
        menu: (
          <ActionsCell
            items={[
              {
                destination: () => this.handleRemove(contact),
    ...
    return (
      <div>
        <ContactModal
          open={openModal}
          email={selectedContact ? selectedContact.email : undefined}
        ...
        >
          ...
          <strong>{selectedContact && name}</strong> as study contact?
        </ConfirmModal>
