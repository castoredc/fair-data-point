...
export default class OrganizationsForm extends Component<OrganizationsFormProps, OrganizationsFormState> {
    ...
    getCenters = () => {
        ...
        apiClient
            .get('/api/study/' + this.props.studyId + '/centers')
            .then(response => {
                this.setState({
    ...
    removeOrganization = () => {
        ...
        if (selectedOrganization) {
            apiClient
                ...
                .then(response => {
                    toast.success(<ToastItem type="success" title={`${selectedOrganization.name} was successfully removed`} />, {
                        position: 'top-right',
                    });
    ...
    render() {
            ...
            return {
                ...
                menu: (
                    <ActionsCell
                        items={[
                            {
                                destination: () => this.handleRemove(organization),
                                label: 'Remove center',
                            },
                        ]}
                    />
        ...
        return (
            <div>
                <OrganizationModal countries={countries} open={openModal} onClose={this.closeModal} studyId={studyId} />
