                    ...
                    return <Form>
                        <div className="FormContent">
                            ...
                            {values.type !== '' && <>
                                ...
                                {values.useApiUser && <div>
                                    {values.apiUserEncrypted ? <div>
                        ...
                        <div className="FormButtons">
                            <Stack distribution="trailing">
                                {distribution ? <Button disabled={isSubmitting} type="submit">
                                    Update distribution
                                </Button> : <Button disabled={isSubmitting} type="submit">
                                    Add distribution
                                </Button>}
                            </Stack>
                        </div>
...
const DistributionSchema = Yup.object().shape({
    ...
    accessRights: Yup.number().oneOf(accessTypes.map(type => type.value)).required('Please select an access type'),
    includeAllData: Yup.boolean().nullable().when('type', {
        is: 'csv',
