...
> {
  constructor(props) {
    ...
    this.state = {
      data: props.object.hasMetadata
        ? mergeData(mergedDefaultMetadata, props.object.metadata)
        : mergedDefaultMetadata,
      currentVersion: props.object.hasMetadata
        ? props.object.metadata.version.metadata
        : null,
      validation: {},
      // isSaved: false,
  ...
  handleSubmit = (values, { setSubmitting }) => {
    ...
    apiClient
      .post(
        "/api/metadata/" + type + (type === "fdp" ? "" : "/" + object.id),
        values
      )
      .then((response) => {
        ...
        toast.success(
          <ToastContent
            type="success"
            message="The metadata are saved successfully"
          />,
          {
            position: "top-right",
          }
                  ...
                  <div className="FormButtons">
                    <Stack distribution="trailing">
                      <Button
                        buttonType="primary"
                        onClick={() =>
                          this.showVersionModal(setFieldValue, handleSubmit)
                        }
