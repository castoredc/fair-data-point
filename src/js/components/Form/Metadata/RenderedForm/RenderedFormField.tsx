...
const FieldComponent: FC<RenderedFormFieldProps> = ({ field, validation, optionGroups, languages, licenses, countries }) => {
    ...
    switch (field.fieldType) {
        ...
        case 'datePicker':
            return <Field component={DatePicker} name={field.id} serverError={validation} />;
        case 'timePicker':
            return <Field component={TimePicker} name={field.id} serverError={validation} />;
...
const RenderedFormField: FC<RenderedFormFieldProps> = ({ field, validation, optionGroups, languages, licenses, countries }) => {
    ...
    return (
        <FormItem label={field.title} details={field.description} isRequired={field.isRequired}>
            {fieldComponent}
        </FormItem>
    );
};
