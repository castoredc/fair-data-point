...
export default class AddStudy extends Component<AddStudyProps, AddStudyState> {
  ...
  render() {
    const { isLoading, studies, selectedStudyId, catalog, submitDisabled } =
      this.state;

    const selectedStudy = selectedStudyId
      ? studies.find((study) => study.sourceId == selectedStudyId)
      : null;
      ...
      <div style={{ marginLeft: "auto", marginRight: "auto" }}>
        ...
        <Stack distribution="center">
          <StackItem style={{ width: toRem(480), marginTop: "3.2rem" }}>
            <BackButton to="/dashboard/studies/add">
              Back to catalogs
            </BackButton>
              ...
              <div>
                ...
                <Stack distribution="trailing" alignment="end">
                  <Button
                    ...
                    onClick={() => this.handleStudySelect(null)}
                    style={{ padding: 0 }}
                  >
