...
> {
    ...
    apiClient
      ...
      .then((response) => {
        ...
        const currentVersion =
          ...
          !["versions", "permissions"].includes(match.params.version)
            ? match.params.version
  ...
  getModules = () => {
    ...
    apiClient
      .get(
        "/api/model/" + dataModel.id + "/v/" + currentVersion.value + "/module"
      )
      .then((response) => {
        this.setState({
  ...
  getNodes = () => {
    ...
    apiClient
      .get(
        "/api/model/" + dataModel.id + "/v/" + currentVersion.value + "/node"
      )
      .then((response) => {
        this.setState({
          nodes: response.data,
  ...
  getPrefixes = () => {
    ...
    apiClient
      .get(
        "/api/model/" + dataModel.id + "/v/" + currentVersion.value + "/prefix"
      )
      .then((response) => {
        this.setState({
  ...
  render() {
    ...
    if (!isGranted("edit", dataModel.permissions)) {
      return (
        <NoPermission text="You do not have permission to edit this data model" />
      );
    }
          ...
          items={[
            ...
            ...(isGranted("manage", dataModel.permissions)
              ? [
                  {
                    to:
                      "/dashboard/data-models/" + dataModel.id + "/permissions",
                    exact: true,
                    title: "Permissions",
                    icon: "usersLight",
                  },
