...
export default class Modules extends Component<ModulesProps, ModulesState> {
  ...
  getOrderOptions = () => {
    ...
    for (let i = 0; i < modules.length; i++) {
      ...
      if (
        currentModule === null ||
        (currentModule && item.id !== currentModule.id)
      ) {
  ...
  render() {
    ...
    const { showModal, currentModule, moduleModalData, tripleModalData } =
      this.state;
              ...
              return {
                ...
                content: (
                  <DataModelModule
                    ...
                    openTripleModal={(tripleData) =>
                      this.openTripleModal(element, tripleData)
                    }
                    openRemoveTripleModal={(tripleData) =>
                      this.openRemoveTripleModal(element, tripleData)
                    }
                  />
                ),
              };
