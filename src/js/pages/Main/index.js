...
export default class Main extends Component {
    render() {
        ...
        return <Switch>
            ...
            <Route path="/fdp/dataset/:dataset/distribution/:distribution" exact
            ...
            <Route path="/fdp/dataset/:dataset/distribution/:distribution/query" exact component={Query}
                   embedded={embedded} user={user}/>

            /* Tools */
            <Route path="/tools/metadata-xml-parse" exact
                   render={(props) => <MetadataXmlParse {...props} embedded={embedded} user={user}/>}/>
