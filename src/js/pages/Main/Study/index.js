...
export default class Study extends Component {
  ...
  render() {
    ...
    let tags = [];
    let badge =
      study && study.metadata.recruitmentStatus
        ? RecruitmentStatus[study.metadata.recruitmentStatus]
        : null;

    if (
      study &&
      study.metadata.condition !== null &&
    ...
    if (
      study &&
      study.metadata.intervention !== null &&
      study.metadata.intervention !== ""
    ) {
          ...
          {study && (
            <>
              <div className="MainCol">
                {study.metadata.contacts.length > 0 && (
                  <Contacts contacts={study.metadata.contacts} />
                )}
