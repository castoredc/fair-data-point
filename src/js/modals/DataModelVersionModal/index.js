...
export default class DataModelVersionModal extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return <Modal
            show={show}
            className="DataModelVersionModal"
        ...
        >
            <ValidatorForm
                ...
                method="post"
            >
                <FormItem label="Please indicate to what extent you are making changes in the data model">
                    <RadioGroup
                        validators={['required']}
