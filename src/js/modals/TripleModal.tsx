...
export default class TripleModal extends Component<TripleModalProps, TripleModalState> {
    ...
    handleSubmit = (values, {setSubmitting}) => {
        ...
        axios.post('/api/model/' + modelId + '/v/' + versionId + '/module/' + module.id + '/triple' + (values.id ? '/' + values.id : ''), values)
            .then((response) => {
                setSubmitting(false);
        ...
        >
            ...
            >
                {({
                    ...
                    const objectSelectable = (values.objectType === 'internal' || values.objectType === 'external' || values.objectType === 'value' || values.objectType === 'literal');
