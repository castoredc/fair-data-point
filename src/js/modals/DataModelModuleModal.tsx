...
export default class DataModelModuleModal extends Component<DataModelModuleModalProps, DataModelModuleModalState> {
    ...
    handleSubmit = (values, {setSubmitting}) => {
        ...
        axios.post('/api/model/' + modelId + '/v/' + versionId + '/module' + (values.id ? '/' + values.id : ''), values)
            .then(() => {
                onSaved();
                setSubmitting(false);
            })
    ...
    handleDelete = (id, callback) => {
        ...
        axios.delete('/api/model/' + modelId + '/v/' + versionId + '/module/' + id)
            .then(() => {
                callback();
                onSaved();
            })
